...
const KV_PRX_URL = "https://raw.githubusercontent.com/kiel-p/akun/refs/heads/main/kvProxyList.json";
const PRX_BANK_URL = "https://raw.githubusercontent.com/kiel-p/akun/refs/heads/main/proxyList.txt";
...
async function getPrxList(prxBankUrl = PRX_BANK_URL) {
  ...
  // Bypass cache agar selalu mendapatkan data terbaru
    ...
    try {
      ...
      if (url.pathname.startsWith("/sub")) {
        ...
        if (apiPath.startsWith("/sub")) {
          ...
          // Memprioritaskan variabel ENV daripada parameter URL dan Konstan
          const prxBankUrl = env.PRX_BANK_URL || url.searchParams.get("prx-list") || PRX_BANK_URL;
  ...
  if (buffer.byteLength >= 62) {
    ...
    if (horseDelimiter[0] === 0x0d && horseDelimiter[1] === 0x0a) {
      if (horseDelimiter[2] === 0x01 || horseDelimiter[2] === 0x03 || horseDelimiter[2] === 0x7f) {
        if (horseDelimiter[3] === 0x01 || horseDelimiter[3] === 0x04) {
          return atob(horse);
        }
      }
    }
